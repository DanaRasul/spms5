...
ALTER TABLE `parking_locations`
  ADD COLUMN IF NOT EXISTS `hourlyRate1` DOUBLE NOT NULL DEFAULT 1000,
  ADD COLUMN IF NOT EXISTS `hourlyRate2` DOUBLE NOT NULL DEFAULT 1500,
  ADD COLUMN IF NOT EXISTS `hourlyRate3` DOUBLE NOT NULL DEFAULT 2000;
